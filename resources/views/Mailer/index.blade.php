			...
			<form class="row g-3" action="{{url('send_mail_to_students')}}" method="POST" >
				...
				<div class="box-body">
                   ...
                   <div class="col-md-3 " style="margin-top: 10px" >
						<button type="button" onclick="getSelectedValues()" class="btn btn-primary" style="margin-top: 25px;">Filter Recipients </button>
					</div>
					<!-- <div>
						<label>.</label>
					</div> -->
					<div class="col-md-12 mt-7" style="margin-top: 10px" >
					...
					<div class="col-md-11" style="margin-top: 10px">
                      <label class="form-label">Body<font color="red"><b>*</b></font></label>
                        <textarea name="body_arr[]" class="form-control" placeholder="" required></textarea>              
                    </div>
					<div class="col-md-1" style="margin-top: 10px">
                    <button type="button" class="btn btn-success" id="addRowBtn" style="float:right; margin-top: 35px"> +Add </button>
                    </div>
