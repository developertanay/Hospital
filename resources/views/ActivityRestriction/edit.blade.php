					...
					<div class="col-xl-12 mx-auto">
						...
						<div class="card">
							<div class="card-body p-4">
								<h4 class="mb-4">Edit Activity Restriction</h4>
					...
					<form class="row g-3" action="{{route($current_menu.'.update', $encrypted_id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        @method('patch')
                            ...
                            <div class="col-md-4">
									...
									<input type="number" name="allowed_past_days" class="form-control" value="{{$data->allowed_past_days}}" onkeypress="return /[0-9\.]/i.test(event.key)" placeholder="Enter Allowed Past Days" >
							</div>
                            <div class="col-md-4">
									<label class="form-label">Allowed Future Days</label>
									<input type="number" onkeypress="return /[0-9\.]/i.test(event.key)" name="allowed_future_days" value="{{$data->allowed_future_days}}" class="form-control" placeholder="Enter Allowed Future Days" >
							</div>
							<div class="col-md-4">
									<label class="form-label">Applicable Till</label>
									<input type="date"  name="applicable_till" value="{{$data->applicable_till}}" class="form-control format-date" placeholder="Enter applicable_till" >
							</div>
                            <div class="col-md-4">
