			...
			<div class="col-xl-12 mx-auto">
				...
				<div class="card">
					<div class="card-body p-4">
						<h5 class="mb-4">Bed-Inventory</h5>
			    ...
			    <form class="row g-3"action="{{route($current_menu.'.update',$id)}}" method="POST" enctype="multipart/form-data">
					...
					<div class="box-body">
			            ...
			            <div class="form-group row" style="margin-top: 10px;">
                            <div class="col-md-4">
	                            <label for="single-select-field" class="form-label">Bed-Type</label>
	                             <select class="form-select single-select-field" name="type"  data-placeholder="Select Bed-Type" >
	                            
								    @foreach($blood as $id => $bloodType)
								        <option value="{{ $id }}" {{ ($data->blood_id == $id) ? 'selected' : '' }}>
								            {{ $bloodType }}
								        </option>
								    @endforeach
								</select>
			                ...
			                <div class="col-md-5">
							    ...
							    <input type="number" name="bed" class="form-control" value="{{$data->count}}" placeholder="Enter Bed Count" min="0" step="1" 
