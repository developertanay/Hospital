    ...
    <div style="width:100vw;height:200vh;display:flex;justify-content:center;align-items:center;z-index:22">
        <div class="text-center px-5">
            <div class="d-flex align-items-center mt-4">
                {{--
                <img src="{{asset('assets/images/logos/Logo_RCDU.original.png')}}" style="position:absolute;width:120px; height: 120px; padding-top:45px;" alt="Ramanujan-Logo">
                --}}
                <br>
            ...
            <h3 style="margin-top:4em;"><u>NO OBJECTION CERTIFICATE</u></h3>
            ...
            <p class="" style="font-size:1.3rem;text-align:justify;" >
                The College has no objection for doing the Internship programme at <strong>{{$application_data->company_name}}</strong> for the period from <strong>{{date('d-M-Y', strtotime($application_data->from_date))}}</strong> to <strong>{{date('d-M-Y', strtotime($application_data->to_date))}}</strong>. It is also certified that he is not registered for any course requiring attendance in the class during the said period.
            </p>
            <p class="" style="font-size:1.3rem;text-align:justify;" >
