						...
						<form action="{{route($current_menu.'.store')}}" method="POST" enctype="multipart/form-data">
						  ...
						  <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
							...
							<div class="row g-3">
								<div class="col-12 col-lg-3">
									...
									<input type="text" class="form-control" name="firstname" id="FisrtName" value="{{!empty($user_data->name)?$user_data->name:''}}" placeholder="First Name" required>
								</div>
								<div class="col-12 col-lg-3">
									<label for="FisrtName" class="form-label">Middle Name</label>
									<input type="text" class="form-control" name="middlename" id="FisrtName" placeholder="Middle Name">
								</div>
								<div class="col-12 col-lg-3">
								...
								<div class="col-12 col-lg-3">
									...
									<input type="text" class="form-control" name="adhaar_no" id="AdhaarNo" placeholder="Adhaar Number">
								</div>
								...
								<div class="col-12 col-lg-4">
									...
									<select class="form-select single-select-clear-field" name="current_state" id="current_state" data-placeholder="Select State" required>
										<option ></option>
								...
								<div class="col-12 col-lg-4">
									...
									<select class="form-select" name="permanent_state" id="permanent_state" required>
										<option ></option>
										@foreach($state_mast as $key =>$value)
						  ...
						  <div id="test-l-3" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger3">
							...
							<div class="table-responsive">
								...
								<tr>
									<td>
										<select class="form-select " name="company_id[]" id="company_id{{$keys}}" data-placeholder="Select Company">
										<option ></option>
										@foreach($company_mast as $key =>$value)
										@if((!empty($values->company_id)?$values->company_id:'') == $key)
										<option value="{{$key}}" selected>{{$value}}</option>
										@else
										<option value="{{$key}}">{{$value}}</option>
										@endif
						...
						@else
							<div class="row g-3">
								<div class="col-12 col-lg-2">
									...
									<input class="form-control " name="company_id" id="company_id1" data-placeholder="Select Company">
								</div>
								<div class="col-12 col-lg-2">
									<label for="" class="form-label"
									>Title</label>
									<select class="form-select " name="company_title_id[]" id="company_title_id1" data-placeholder="Select Title" onchange="toggleTitleField(this,'other_title0')">
										<option ></option>
										@foreach($job_title_mast as $key =>$value)
										<option value="{{$key}}">{{$value}}</option>
										@endforeach
								...
								<div class="col-12 col-lg-2" id="other_title0" style="display:none;">
									...
									<input type="text" class="form-control" name="other_title_text[]" id="company_title_id1" data-placeholder="Enter Title">
								</div>
								<div class="col-12 col-lg-2">
								...
								<div class="col-12 col-md-1" id="employed_from">
									...
									<input type="number" class="form-control"  name="employed_from" placeholder="Enter Start Date" required>
								</div>
								<div class="col-12 col-md-1" id="employed_till">
									<label for="" class="form-label">till</label>
									<input type="number" class="form-control"  name="employed_till" onkeyup="maxyear();" max="2024" placeholder="Enter End Date">
								</div>
								<div class="col-12 col-md-3" >
									<button type="button" class="btn btn-success" id="addRowBtn1" onclick="addExperienceRow()">+ADD MORE ROW</button>
								</div>
						  ...
						  <div id="test-l-4" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger4">
							...
							<div class="row g-3">
								<div class="col-12 col-lg-auto">
									...
									>Skill/s </label>
									<select class="form-select multiple-select-field" name="skills[]" id="skills" data-placeholder="Choose Skills" multiple required onchange="toggleSkillField(this,'additional_skills_0')">
										<option ></option>
...
<script>
    ...
    const additionalRowsContainer = document.getElementById('additionalRowsContainer');
        ...
        newRow.innerHTML = `
        	<div class="row g-3">
				...
				<div class="col-12 col-md-2">
					<label for="" class="form-label">Status<font color="red"><b>*</b></font></label>
					<select class="form-select " name="qualification_status[]" id="qualification_status" data-placeholder="Select Status" onchange="toggleYearDropdown(this,'year_of_passing_${rowCounter}')" required>
						<option ></option>
						<option value="1">Currently Pursuing</option>
						<option value="2">Pass-Out</option>
					  </select>
				</div>
				<div class="col-12 col-md-2" id="year_of_passing_${rowCounter}">
					<label class="form-label">Year of Passing</label>
					<input type="number" class="form-control" id="passing_year" name="year_of_passing[]" onkeyup="maxyear();" max="{{date('Y')}}" placeholder="Enter Passing Year">
				</div>
				<div class="col-md-4">  
                <button class="btn btn-danger" onclick="removeQualificationRow(${rowCounter})"> - Remove</button>
    ...
    const additionalRowsContainer1 = document.getElementById('additionalRowsContainer1');
        ...
        newRow1.id = `additionalRow_${rowCounter1}`;

        newRow1.innerHTML = `
    	<div class="row g-3">
			<div class="col-12 col-lg-2">
			    <label for="" class="form-label">Company</label>
				<input class="form-control " name="company_id" id="company_id" data-placeholder="Select Company">
			</div>
			<div class="col-12 col-lg-2">
			...
			<div class="col-12 col-lg-2">
				<label for="" class="form-label">Type</label>
				<select class="form-select " name="company_type_id[]" id="compnay_type_id" data-placeholder ="Select Type">
					<option ></option>
					@foreach($job_type_mast as $key =>$value)
					<option value="{{$key}}">{{$value}}</option>
					@endforeach
			...
			<div class="col-md-4">  
	        <button class="btn btn-danger"  onclick="removeExperienceRow(${rowCounter1})"> - Remove</button>
            </div>
		</div>
        `;
    ...
    function removeExperienceRow(rowNumber1) {
        const rowToRemove1 = document.getElementById(`additionalRow_${rowNumber1}`);
    ...
    const current_state = document.getElementById('current_state').value;
    ...
    const current_state_element = document.getElementById('current_state');
