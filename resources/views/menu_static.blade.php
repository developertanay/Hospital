...
@if(Auth::user()->role_id == 1)
				...
				<li>
					...
					<ul>
					<a  href="{{url('Groups')}}"><i class='bx bx-radio-circle'></i>Groups</a>
					</ul>
					<ul>
					<a  href="{{url('LeaveType')}}"><i class='bx bx-radio-circle'></i>Leave Type</a>
					</ul>
					<ul>
					<a  href="{{url('LeaveTypeTransaction')}}"><i class='bx bx-radio-circle'></i>Leave Type Transaction</a>
					</ul>
				</li>
				<li>
					<a class="has-arrow" href="javascript:;">
					...
					<ul>
					<a  href="{{url('AssignmentType')}}"><i class='bx bx-radio-circle'></i>Assignment Type</a>
					</ul>
					<ul>
					<a  href="{{url('AssignmentMode')}}"><i class='bx bx-radio-circle'></i>Assignment Mode</a>
					</ul>
					<ul>
					<a  href="{{url('AssignmentMast')}}"><i class='bx bx-radio-circle'></i>Create Assignment</a>
					</ul>
				</li>
				<li>
					<a class="has-arrow" href="javascript:;">
