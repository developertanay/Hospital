			...
			<div class="page-content">
			  ...
			  <!--start stepper one--> 
				...
				<div id="stepper2" class="bs-stepper">
					<div class="card">
					  <form class="row g-3" action="{{ route('UserProfileMast/edit') }}" method="POST" enctype="multipart/form-data">
						  ...
						  <form action="{{route($current_menu.'.store')}}" method="POST"  enctype="multipart/form-data" >
							...
							<div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
							  ...
							  <div class="row g-3">
								  ...
								  <div class="col-12 col-lg-2">
									  ...
									  <input type="text" class="form-control" name="mother_name"  placeholder="Enter Your Mother's Name" required>
								  </div>
								  ...
								  <div class="col-12 col-lg-2">
								   ...
								   <div class="col-12 col-lg-2">
									  ...
									  <input type="text" class="form-control" name="parent_contact_no" placeholder="Enter Your Parent's Contact  Number">
								  </div>
								   <div class="col-12 col-lg-2">
									  <label for="DOB" class="form-label">Date of Birth<font color="red"><b>*</b></font></label>
									  <input type="text" class="form-control date-format" name="dob" placeholder="Select Date of Birth" required>
								  </div>
								...
								<div class="col-12 col-lg-2">
										<label for="single-select-clear-field" class="form-label">Gender<font color="red"><b>*</b></font></label>
										 <select class="form-select single-select-clear-field" name="gender"  data-placeholder="Choose Gender" required>
											 <option></option>
									 ...
									 <div class="col-12 col-lg-2">
										<label for="single-select-clear-field" class="form-label">Category<font color="red"><b>*</b></font></label>
										 <select class="form-select single-select-clear-field" name="category"  data-placeholder="Choose Category" required>
											 <option></option>
								...
								<div class="col-12 col-lg-8">
									...
									<input type="text" name="current_address"  id="current_address"  class="form-control" placeholder="Enter Current Address" required>
								</div>
								<div class="col-12 col-lg-2">
										<label for="single-select-clear-field" class="form-label">Current State<font color="red"><b>*</b></font></label>
										 <select class="form-select single-select-clear-field" name="current_state" id="current_state" data-placeholder="Choose Current State" required>
											 <option></option>
									...
									<input type="text" name="current_pin_code" id="current_pin_code" class="form-control" placeholder="Enter Current Pin Code" required>
								</div>

								<!-- <div class="form-group row"> -->
								<div class="col-12 col-lg-12">
									<input type="checkbox" id="address_same" name="address_same" onclick="check_address_checkbox()">
							...
							<!-- </div> -->
								...
								<div class="col-12 col-lg-8">
									...
									<input type="text" name="permanent_address" id="permanent_address"  class="form-control" placeholder="Enter Permanent Address" required>
								</div>
								<div class="col-12 col-lg-2">
										<label for="single-select-clear-field" class="form-label">Permanent State<font color="red"><b>*</b></font></label>
										 <select class="form-select single-select-clear-field" name="permanent_state" id="permanent_state"  data-placeholder="Choose Permanent State" required>
											 <option></option>
											 @foreach($state_mast as $key => $value) 
										<option value="{{$key}}">{{$value}}</option>
										@endforeach
								...
								<div class="col-12 col-lg-2">
									...
									<input type="text"  name="permanent_pin_code" id="permanent_pin_code"  class="form-control" placeholder="Enter Permanent Pin Code" required>
								</div>
							 ...
							 <div class="col-12 col-lg-2">
									...
									<div class="col-12 col-lg-2">
									  ...
									  <input type="text" class="form-control" name="cuet_score" placeholder="Enter CUET Score" required>
								  </div>
							...
							<h5 class="mb-1">Academics Details</h5>
										...
										<div class="row g-3">
											<div class="col-12 col-lg-2">
												...
												<select class="form-select single-select-clear-field" name="qualification[]" data-placeholder="Choose Qualification" required>
													<option></option>
											...
											<div class="col-12 col-lg-2">
												...
												<input type="text" class="form-control" name="board_university_name[]" placeholder="Enter Your Board/University Name" required>
											</div>
											<div class="col-12 col-lg-2">
												<label for="School/College Name" class="form-label">School/College<font color="red"><b>*</b></font></label>
												<input type="text" class="form-control" name="school_college_name[]" placeholder="Enter Your School/University Name" required>
											</div>
											<div class="col-12 col-lg-1">
												<label for="marks" class="form-label">Marks(%)<font color="red"><b>*</b></font></label>
												<input type="text" class="form-control" name="marks[]" placeholder="Enter Your Marks(in %)" required>
											</div>
											<div class="col-12 col-lg-1">
												<label for="passing_year" class="form-label">Year<font color="red"><b>*</b></font></label>
												<input type="text" class="form-control" name="passing_year[]" placeholder="Enter Your Passing Year" required>
											</div>
											<div class="col-12 col-lg-2">
												<label class="form-label">Upload Marksheet<font color="red"><b>*</b></font></label>
												<input class="form-control" style="width: 150%;" type="file" name="document[]" required>
											</div>
							  ...
							  <div class="row g-3">
								  <div class="col-12 col-lg-4">
										<label for="single-select-clear-field" class="form-label">Document-1<font color="red"><b>*</b></font></label>
										 <select class="form-select single-select-clear-field" name="document_type[]"  data-placeholder="Choose one document type" required>
											 <option></option>
								  ...
								  <div class="col-12 col-lg-4">
									...
									<input class="form-control" style="width: 150%;" type="file" name="document1[]" required>
								</div>
								<div id="additionalRowsContainer_dox">
								  ...
								  <div class="col-12">
									  <div class="d-flex align-items-center gap-3">
										  ...
										  <button type="submit" class="btn btn-success px-4" onclick="stepper2.next()">Submit</button>
									  </div>
								  </div>
							  </div><!---end row-->
    ...
    addRowButton.addEventListener('click', () => {
        ...
        newRow.innerHTML = `
            <div class="col-12 col-lg-2">
                ...
                <select class="form-select single-select-clear-field" name="qualification[]" data-placeholder="Choose Qualification" >
                    <option></option>
                    @foreach($qualification_mast as $key => $value)
                        <option value="{{$key}}">{{$value}}</option>
                    @endforeach
            ...
            <div class="col-12 col-lg-2">
                ...
                <input type="text" class="form-control" name="board_university_name[]" placeholder="Enter Your Board/University Name">
            </div>
            <div class="col-12 col-lg-2">
                <label for="School/College Name" class="form-label">School/College</label>
                <input type="text" class="form-control" name="school_college_name[]" placeholder="Enter Your School/University Name" >
            </div>
            <div class="col-12 col-lg-1">
                <label for="marks" class="form-label">Marks(%)</label>
                <input type="text" class="form-control" name="marks[]" placeholder="Enter Your Marks(in %)" >
            </div>
            <div class="col-12 col-lg-1">
                <label for="passing_year" class="form-label">Year</label>
                <input type="text" class="form-control" name="passing_year[]" placeholder="Enter Your Passing Year" >
            </div>
            <div class="col-12 col-lg-2">
